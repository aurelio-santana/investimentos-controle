...
@Component({
  ...
  styleUrls: ['./lightweight.component.css'],
  encapsulation: ViewEncapsulation.None /* desabilitar as classes custom do Angular,
  caso contrário o CSS não funcionará nos elementos criados no .ts */
})
export class LightweightComponent implements OnInit {
  ...
  createChartArea(){
    ...
    /* document.body.appendChild(chartElement2);
